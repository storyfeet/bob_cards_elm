...
cards_out/all_pages.pdf :all_pages
	pdfunite cards_out/front*.pdf cards_out/backs.pdf cards_out/tiles*.pdf cards_out/tile_backs*.pdf  cards_out/widefront*.pdf cards_out/wideback*.pdf cards_out/all_pages.pdf
