...
setupStr s =
    case s of 
        ...
        Score Solo -> "Add a Meeple to the '0' on the horshoe score track"
        Score Coop -> "Add a Meeple of any colour to the '0' on the horseshoe score track"
        Score Versus -> "Add one Meeple for each player to the '0' on the horseshoe score track"
        Bandits l -> "Add a bandit (red counter) " ++ banditSpaces l ++ " West of the Meeples"
        Grid n -> "Draw and layout " ++ String.fromInt (n*3) ++ " Map Tiles face up in a " ++ String.fromInt n ++ "x3 Grid.\nThen another "++String.fromInt (n * 2 + 3)  ++ " face down around them to the North, South, and West (No Diagonal)"
